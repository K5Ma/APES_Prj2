...
//         *
//         *
//         * Param_1: bool EP_Update
//         *          (false: don't do anything, true: update the EPaper Display)
//         *
//         * Param_2: char *Image_Name
//         *          (don't care if EP_Update is false, otherwise should contain
...
//
//        EP_Update = true;
//        strncpy(Image_Name, "123.BMP", sizeof(Image_Name));
//        #if     EP_DEBUG_PRINTF
//            EP_Print("\nStorage Get");
//        #endif
